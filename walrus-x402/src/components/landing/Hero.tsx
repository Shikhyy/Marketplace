    ...
    return (
        <section ref={containerRef} className="relative min-h-[120vh] flex flex-col items-center pt-24 pb-20 px-4 overflow-visible">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
                ...
                <motion.div style={{ rotate: rotateOrbits, opacity: opacityOrbits }} className="absolute top-[25vh] left-1/2 -translate-x-1/2 w-[180vw] aspect-square rounded-full border-[1px] border-white/10 mask-linear-fade" />
                <motion.div style={{ rotate: rotateOrbits, opacity: opacityOrbits }} className="absolute top-[35vh] left-1/2 -translate-x-1/2 w-[160vw] aspect-square rounded-full border-[1px] border-indigo-500/20 shadow-[0_0_100px_rgba(99,102,241,0.2)]" />
